...
def get_parser():
    ...
    parser.add_argument('--train_img_dirs', default="../datasets/plates/train", help='the train images path')
    parser.add_argument('--test_img_dirs', default="../datasets/plates/val", help='the test images path')
...
def train():
    ...
    for iteration in range(start_iter, int(max_iter)):
        ...
        if iteration % 20 == 0:
            # here is my code
            # lr = lprnet.optimizer.state_dict()['param_groups'][0]['lr']
